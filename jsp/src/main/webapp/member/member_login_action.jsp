...
if (member == null || !member.getPasswd().equals(passwd)) {
  ...
  request.getContextPath() + "/index.jsp?group=member&worker=member_login&returnUrl="
      + URLEncoder.encode(returnUrl, "utf-8"));
  return;
}

//아이디를 전달받아 MEMBER 테이블에 저장된 회원 정보의 마지막 로그인 날짜를 변경하는 DAO 클래스의 메소드 호출
...
//페이지 이동
if (returnUrl.equals("")) { //반환받은 요청 JSP 문서의 URL 주소가 없는 경우 - 메인 페이지 이동
