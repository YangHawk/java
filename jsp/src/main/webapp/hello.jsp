...
<body>
	<h1>Hello, JSP!!!</h1>
	<hr>
	<!-- HTML 주석: 주석문이 클라이언트에게 전달됨 - 소스 보기 가능: 웹 디자이너 -->
	<%-- JSP 주석: 주석문이 클라이언트에게 전달되지 않음 - 소스 보기 불가능: 웹 프로그래머 --%>
	<p>JSP(Java Server Page): 서블릿보다 쉽 게 웹 프로그램을 작성하기 위한 기술 - 스크립트 요소(Script Element), 지시어(Directive), 표준 액션 태그(Standard Action Tag)</p>
