...
//비로그인 상태의 사용자가 JSP 문서를 요청한 경우 [member/member_login.jsp] 문서로 이동하기 위한 URL 주소를 클라이언트에게 전달하여 응답
//▶ 로그인 후 요청 기존 요청 JSP 문서로 이동되도록 설정(원래는 로그인 하면 main_page.jsp)
//두가지 방법: 1. session / 2. Query String 이용

if (loginMember == null) {
  //request.getRequestURI(): 요청 JSP 문서의 경로를 반환하는 메소드
