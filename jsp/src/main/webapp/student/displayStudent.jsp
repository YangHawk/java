...
<%-- ▶ 학생 정보 출력 태그의 [변경] 태그를 클릭한 경우 [updateFormStudent.jsp] 문서를 요청하여 이동 - 학생 번호 전달--%>
<%-- ▶ 학생 정보 출력 태그의 [삭제] 태그를 클릭한 경우 [deleteStudent.jsp] 문서를 요청하여 이동 - 학생 번호 전달--%>
<%
...
<body>
	...
	<table align="center" border="1" cellspacing="0" cellpadding="1" width="800">
		...
		<tr align="center">
			...
			<td width="100"><%=student.getEmail()%></td>
	...
	function removeConfirm(no) {
		if(confirm("학생 정보를 정말로 삭제하시겠습니까?")) {
