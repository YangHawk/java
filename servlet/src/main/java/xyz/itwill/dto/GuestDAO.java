...
public class GuestDAO extends JdbcDAO {
	...
	// 방명록 게시글 정보를 전달받아 GUEST 테이블에 삽입하고 삽입 행의 갯수를 반환하는 메소드
	...
	// 방명록 게시글 정보를 전달받아 GUEST 테이블에 저장된 행을 변경하고 변경 행의 갯수를 반환하는 메소드
	...
	// 방명록 게시글 정보를 전달받아 GUEST 테이블에 저장된 행을 삭제하고 삭제 행의 갯수를 반환하는 메소드
	...
	// 방명록 게시글 정보를 전달받아 GUEST 테이블에 저장된 행을 검색하여 반환하는 메소드
