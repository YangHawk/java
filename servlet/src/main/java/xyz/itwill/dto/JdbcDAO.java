...
//JDBC 기능을 제공하는 DAO 클래스가 상속받아 사용하기 위하여 작성된 부모클래스 - 추상 클래스
//→ WAS 프로그램에 의하여 관리되는 DataSource 객체를 제공받아 필드값으로 저장 - 정적 영역에 작성하여 한번만 실행
...
public abstract class JdbcDAO { // 상속만을 목적으로 작성된 클래스
	...
	public Connection getConnection() throws SQLException {
		return dataSource.getConnection(); // DataSource 객체로부터 Connection 객체를 제공받아 반환
	}
