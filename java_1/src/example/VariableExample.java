...
public class VariableExample {
	public static void main(String[] args) {
		...
		int totWeight = 759, each1 = 10;
		double aveWeight = (double) totWeight / each1;
		...
		String name="홍길동";
		int kor = 89, eng = 93, math = 95, each2 = 3;
		int tot = kor + eng + math;
		double ave2 = tot / (double) each2;
		System.out.println(name+"의 점수는 총점 " + tot + "점이고, 평균 " + (int) (ave2 * 10) / 10.0 + "점이다.");
