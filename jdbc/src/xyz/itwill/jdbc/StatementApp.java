...
// → 문자열 결합을 사용할 경우 가독성 및 유지보수의 효율성 감소
// → InSQL 해킹 기술(값 대신 부분적인 SQL을 입력하여 공격)에 취약
public class StatementApp {
	public static void main(String[] args) throws Exception {
		
		/*
		// 키보드로 학생 정보를 입력받아 STUDENT 테이블에 삽입하고 STUDENT 테이블에 저장된
		// 모든 학생 정보를 검색하여 출력하는 JDBC 프로그램 작성

		// 키보드로 학생 정보를 입력받기 위한 입력 스트림을 생성
		...
		*/
		...
		//select * from student where name ='' or '1'='1' order by no
