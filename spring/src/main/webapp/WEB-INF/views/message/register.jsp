...
<%-- JSP 문서에 Spring 관련 태그를 사용할 수 있는 Spring 태그 라이브러리 추가 --%>
	...
	<form:form action="${url }" method="post" modelAttribute="product">
		<table>
			<tr>
				...
				<%-- code 속성: Properties 파일에서 메세지를 제공하기 위한 식별자(이름)를 속성값으로 설정 --%>
			...
			<tr>
				...
				<td>
					<form:input path="productQty" value=""/>
					<form:errors path="productQty" element="span"/>
				</td>
			</tr>
			<tr>
				<td colspan="2">
