...
public class CollectionBeanApp {
	public static void main(String[] args) {
		...
		// ▶ Collection 객체의 toString() 메소드 호출 - Collection 객체에 저장된 모드 요소값 출력
		System.out.println("nameSet = " + bean.getNameSet()); // nameSet = null → [홍길동, 임꺽정, 전우치]
		System.out.println("nameList = " + bean.getNameList()); // nameList = null → [홍길동, 임꺽정, 전우치, 홍길동]
		System.out.println("==========================================================");
