...
//DAO 클래스: 저장 매체(File / DBMS 등)의 행 삽입 / 변경 / 삭제 / 검색 기능을 제공하는 클래스
//▶ 저장 매체의 종류 또는 방법에 따라 DAO 클래스 변경 가능
//▶ DAO 클래스가 변경되어도 DAO 클래스를 사용하는 클래스(Service 클래스)에 영향을 최소화하기 위하여 반드시 인터페이스를 상속받아 작성 - 결합도를 낮춰 유지 보수의 효율성 ↑
