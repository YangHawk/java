...
public class MessagePrint {
	// MessageObject 인터페이스를 상속받은 자식 클래스의 객체를 저장하기 위한 필드
	// ▶ 필드에 객체를 저장하기 위한 생성자 또는 Setter 메소드를 반드시 작성 - 포함 관계
	...
	public void messagePrint() {
		// 필드에 객체가 저장되지 않은 경우 메소드 호출 시 NullPointerException(NPE) 발생
