...
//▶ 클래스의 이름을 Spring Bean을 구분하는 식별자(beanName)로 사용 - 첫번째 문자는 소문자로 변경됨
//▶ @Component 어노테이션 value 속성을 사용하여 식별자(beanName) 변경 가능 - value 속성만 존재할 경우 속성값만 설정 가능 
@Component(value = "changeBean")
