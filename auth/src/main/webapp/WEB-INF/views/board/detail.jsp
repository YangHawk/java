...
<body>
	...
	// 현재 로그인 사용자의 아이디를 자바 스크립트 변수에 저장
	...
	$("addBtn").click(function() {
		...
		$.ajax({
			...
			// beforeSend 속성: 페이지 요청 전에 실행될 명령이 저장된 함수를 속성값으로 설정
			// ▶ 매개 변수로 XMLHttpRequest 객체를 제공받아 사용 가능
			/*
			beforeSend: function(xhr) {
				// XMLHttpRequest 객체의 요청 메세지의 머릿부에 CSRF 토큰을 저장
				xhr.setRequestHeader(csrfHeaderName, csrfTokenValue);				
			}			
			*/
			dataType: "text",
