...
public class FilmController {
	...
	public String modifyFilm(@ModelAttribute Film film, Model model, HttpServletRequest request)
			throws FestivalinfoNotFoundException {
		model.addAttribute("filminfo", filmService.getFilm(film.getIdx()));
		String command = request.getHeader("referer");
		model.addAttribute("command", command);
	...
	public String modifyFilm(@ModelAttribute Film film, @RequestParam("multipartFile") MultipartFile multipartFile,
			Model model, @RequestParam("command") String command, HttpServletRequest request)
	...
	public String removeFilm(@ModelAttribute Film film, Model model) {
		filmService.modifyFilmStatus(film.getIdx());
		model.addAttribute("idx", filmService.getFilm(film.getIdx()).getFestivalIdx());
