...
public class CommunityController {
   ...
   public String getNoticeForm(@RequestParam("title") String title, @RequestParam("content") String content,
   ...
   public String getQnaForm(@RequestParam("title") String title, @RequestParam("content") String content,
         @RequestParam("uploadFile") MultipartFile uploadFile, HttpServletRequest request,
   ...
   public String getSecretQnaForm(@RequestParam("title") String title, @RequestParam("content") String content,
         @RequestParam("uploadFile") MultipartFile uploadFile, Authentication authentication) {
