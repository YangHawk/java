        ...
        <div class="text-wrap text-center">
            ...
            <c:choose>
               <c:when test="${donation.payType == 0}">
                  <p class="space-top-2x"><button type="button" id="html5_inicis" class="btn btn-default-filled btn-rounded pay"><i class="fa fa-long-arrow"></i><span>지금 결제하기</span></button></p>
               </c:when>
               <c:otherwise>
                  <p class="space-top-2x"><button type="button" id="kakaopay" class="btn btn-default-filled btn-rounded pay"><i class="fa fa-long-arrow"></i><span>지금 결제하기</span></button></p>
               </c:otherwise>
            </c:choose>
            <p class="space-top-2x"><a href="${pageContext.request.contextPath}/" class="btn btn-default-filled btn-rounded"><i class="fa fa-long-arrow"></i><span>나중에 결제하기</span></a></p>
        </div><!-- / text-wrap -->
    </div><!-- / container -->
</section>
