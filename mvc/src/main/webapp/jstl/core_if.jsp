...
<body>
	<h1>Core - 흐름 제어 태그</h1>
	<hr>
	<%-- if 태그: 조건에 대한 결과에 따라 태그 내용 포함 여부를 선택하는 태그 --%>
	<%-- test 속성: false | true 를 속성값으로 설정 --%>
	<%-- ▶ test 속성값이 [false]인 경우 태그 내용을 포함하지 않고 [true]인 경우에만 태그 내용 포함 --%>
	<c:if test="true">
	...
	<%-- test 속성값으로 EL 사용 시 EL 표현식에서 EL 연산자를 사용하여 [false] 또는 [true] 중 하나를 제공받아 사용 가능 --%>
