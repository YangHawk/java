...
public class ViewModel implements Action {
  ...
  public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // UserinfoService 클래스의 getUserinfo() 메소드를 호출하여 검색된 회원 정보를 DTO 객체로 반환받아
      // request 객체의 속성값 저장
      // ▶ UserinfoService 클래스의 getUserinfo() 메소드를 호출하여 검색된 회원 정보가 없는 경우
      // UserinfoNotFoundException 예외 발생 - 비정상적인 요청
